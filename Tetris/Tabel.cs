...
namespace Tetris
{
    ...
    class Tabel
    {
        ...
        public void DrawTableBorder(Game game)
        {
            ...
            {
                game.matrice[i, 21] = 1;
                game.tableLayoutPanel1.GetControlFromPosition(i, 21).BackColor = Color.DarkGreen;
                game.matrice[i, 0] = 1;
                game.tableLayoutPanel1.GetControlFromPosition(i, 0).BackColor = Color.DarkGreen;
            ...
            {
                game.matrice[0, i] = 1;
                game.tableLayoutPanel1.GetControlFromPosition(0, i).BackColor = Color.DarkGreen;

                game.matrice[11, i] = 1;
                game.tableLayoutPanel1.GetControlFromPosition(11, i).BackColor = Color.DarkGreen;
